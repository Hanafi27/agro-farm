...
@section('title', 'Tambah Pendapatan - Ciwidey Agro Farm')
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="mb-6">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-2xl font-bold text-gray-800">Tambah Pendapatan Baru</h2>
                <p class="text-gray-600 mt-1">Input pendapatan dari perkebunan atau peternakan</p>
            </div>
    ...
    <div class="bg-white rounded-lg shadow-md">
        ...
        <form action="{{ route('admin.pendapatan-susu.store') }}" method="POST" class="p-6 space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="number" min="0" name="jumlah_liter" id="jumlah_liter" value="{{ old('jumlah_liter') }}" required
                ...
                <div>
                    ...
                    <input type="number" min="0" name="harga_per_liter" id="harga_per_liter" value="{{ old('harga_per_liter') }}" required
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-agro-green focus:border-transparent transition-colors" oninput="hitungTotalPendapatan()">
                ...
                <div>
                    ...
                    <input type="number" min="0" name="total_pendapatan" id="total_pendapatan" value="{{ old('total_pendapatan') }}" readonly
